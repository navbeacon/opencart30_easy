...
//        $order_query = $this->db->query("SELECT event_id FROM `" . DB_PREFIX . "event`  WHERE code = 'update_charged_payment_status'");
//        if (empty($order_query->num_rows)) {
//            $this->load->model('setting/event');
//            $this->model_setting_event->addEvent('update_charged_payment_status', 'admin/controller/sale/order/info/before', 'extension/payment/dibseasy/updateChargedPaymentStatus');
//        }
    }
